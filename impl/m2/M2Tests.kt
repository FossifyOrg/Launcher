...
import org.fossify.launchpad.config.CooldownRulesConfig
import org.fossify.launchpad.config.CooldownRulesValidator
...
class M2IntegrationTests {
    ...
    fun testMultiplePromisesAndRequests() {
        ...
        val approvedRequests = requests.map { r, idx ->
            dogeManager.approveRequest(r, "Papa", 20 + idx)
        }.withIndex().map { it.value }
