...
import org.fossify.launchpad.models.TimeBudget
...
class TimeBudgetManager(
    ...
    private suspend fun getCooldownState(lastTx: org.fossify.home.databases.entities.CryptoCashTransaction?): Pair<Boolean, Long?> {
    ...
    suspend fun recordAppLaunch(packageName: String, durationMinutes: Int) {
        ...
        database.cryptoCashDao().insertTransaction(
            org.fossify.home.databases.entities.CryptoCashTransaction(
